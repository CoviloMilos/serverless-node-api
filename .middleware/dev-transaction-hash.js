...
const src_handlers_transaction_handler = require('../src/handlers/transaction-handler');
...
module.exports.handler = async (event, context) => {
  ...
  return Promise.resolve()
    ...
    .then(wrappedHandler(src_handlers_transaction_handler.getTransactionByHash.bind(src_handlers_transaction_handler)))
